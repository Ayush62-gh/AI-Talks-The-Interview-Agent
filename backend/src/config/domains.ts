...
export const DOMAIN_PROFILES: Record<string, DomainProfile> = {
  ...
  'Software Engineer': {
    ...
    coreTopics: [
      ...
      'System Design & Scalability',
      'SQL vs NoSQL Database Trade-offs',
    ...
    secondaryTopics: ['Microservices Communication', 'Software Security & OWASP', 'Caching Strategies'],
    optionalTopics: ['Event-Driven Architecture', 'Code Reviews & SemVer'],
    forbiddenTopics: ['RAG', 'Vector Databases', 'Prompt Engineering', 'Agentic AI', 'MCP'],
    progression: [
  ...
  'DevOps Engineer': {
    ...
    coreTopics: [
      ...
      'CI/CD Pipelines & Zero-Downtime Rollouts',
    ...
    secondaryTopics: ['SRE & Error Budgets', 'Load Balancing & TLS', 'Service Mesh (Istio)'],
    optionalTopics: ['Serverless DevOps Automation', 'Ansible Configuration Management'],
    forbiddenTopics: ['RAG', 'Vector Databases', 'Prompt Engineering', 'Agentic AI', 'MCP', 'React Hooks', 'JSX'],
    progression: [
      'Docker Containerization',
      'Kubernetes Orchestration',
      'CI/CD & Zero-Downtime Rollouts',
      'Infrastructure as Code (Terraform)',
      'Prometheus & Grafana Monitoring',
      'Cloud IAM & Least Privilege',
      'Centralized Logging (ELK Stack)',
  ...
  'Data Analyst': {
    ...
    coreTopics: [
      ...
      'Pandas Data Wrangling & Pivot Tables',
    ...
    secondaryTopics: ['Cohort & Retention Analytics', 'CTEs vs Subqueries', 'Python Data Visualization'],
    optionalTopics: ['ETL Pipeline Fundamentals', 'A/B Testing Sample Size'],
    forbiddenTopics: ['RAG', 'Vector Databases', 'Prompt Engineering', 'Agentic AI', 'MCP', 'Spring Boot', 'Kubernetes'],
    progression: [
      'SQL Joins & Aggregations',
  ...
  'Data Scientist': {
    ...
    coreTopics: [
      ...
      'Python Data Ecosystem (NumPy, Pandas, Scikit-learn)',
      'A/B Testing & Experimentation',
    ],
    secondaryTopics: ['Deep Learning Fundamentals', 'Time Series Forecasting'],
    optionalTopics: ['MLOps & Model Deployment'],
    forbiddenTopics: ['React', 'CSS', 'HTML', 'Spring Boot', 'Kubernetes'],
    progression: [
  ...
  'Product Manager': {
    ...
    coreTopics: [
      ...
      'User Metrics & Funnel Analytics (Retention, Churn)',
      'Behavioral & Stakeholder Scenario Questions',
      'Agile & Scrum Execution',
    ],
    secondaryTopics: ['Market Research & Competitive Analysis', 'Product Discovery'],
    optionalTopics: ['Go-To-Market Strategy'],
    forbiddenTopics: ['JVM Garbage Collection', 'Vector Indexes', 'Kubernetes Ingress'],
    progression: [
      'Product Strategy',
      'Feature Prioritization',
      'User Metrics & Analytics',
      'Stakeholder Management',
      'Product Execution & Launch',
    ],
  },
};
